...
gcc exercise-tutorial-2.c -o exercise-tutorial-2 `pkg-config --cflags --libs gstreamer-1.0`
gcc exercise-tutorial-3.c -o exercise-tutorial-3 `pkg-config --cflags --libs gstreamer-1.0`
gcc exercise-tutorial-3.c -o exercise-tutorial-3 `pkg-config --cflags --libs gstreamer-1.0`
